...
public class JoinDriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.join_driver);
        ...
        btnJoin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String driverBus = busText.getText().toString();


                InsertData task = new InsertData();
                task.execute("http://" + IP_ADDRESS + "/insertDriver.php",userId,userPw,userName,userBirth,userPhone,driverBus);
    ...
    class InsertData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(JoinDriverActivity.this,
        ...
        protected void onPostExecute(String result) {
            ...
            Intent i = new Intent(JoinDriverActivity.this, LoginActivity.class);
            startActivity(i);
        }
        ...
        protected String doInBackground(String... params) {
            ...
            String driverBus = (String)params[6];


            String serverURL = (String)params[0];
            String postParameters = "userId=" + userId + "&userPw=" + userPw + "&userName=" + userName + "&userBirth=" + userBirth + "&userPhone=" + userPhone + "&driverBus=" + driverBus;
