...
public class ComplainWrite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.complain_write);
        ...
        btnhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(ComplainWrite.this, StartActivity.class);
                startActivity(i);
            }
        });
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(ComplainWrite.this, ComplainActivity.class);
                startActivity(i);
            }
        });
        ...
        btnAdmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                task.execute("http://" + IP_ADDRESS + "/insertComplain.php",titleText,dateText,contentText,writerText);
    ...
    class InsertData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ComplainWrite.this,
